...
--
-- Table structure for table `lectur_registe_mst`
--

DROP TABLE IF EXISTS `lectur_registe_mst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lectur_registe_mst` (
...
--
-- Dumping data for table `lectur_registe_mst`
--

LOCK TABLES `lectur_registe_mst` WRITE;
/*!40000 ALTER TABLE `lectur_registe_mst` DISABLE KEYS */;
/*!40000 ALTER TABLE `lectur_registe_mst` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `lecture_mst` VALUES (1,'java기초',500000,1);
...
--
-- Table structure for table `studet_mst`
--

DROP TABLE IF EXISTS `studet_mst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `studet_mst` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  `birth_date` date NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `studet_mst`
--

LOCK TABLES `studet_mst` WRITE;
/*!40000 ALTER TABLE `studet_mst` DISABLE KEYS */;
/*!40000 ALTER TABLE `studet_mst` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-04-07 17:46:22
